...
|                |                                                              |                                                       |
| -------------- | ------------------------------------------------------------ | ----------------------------------------------------- |
| 处理器 (CPU)   | Celeron 2950M                                                | 2.0GHz                                                |
| 内存 (RAM)     | 类型：**DDR3L** 1600 (PC3L-12800)<br />插槽：2 个插槽<br />容量：标配通常为 2GB 或 4GB，**最大支持 16GB**。 |                                                       |
| 显卡 (GPU)     | Intel HD Graphics 4600 (集成在 CPU 中)                       |                                                       |
| 存储 (HDD/SSD) | 标配通常是 320GB 或 500GB 的机械硬盘 (HDD)                   | 接口为 SATA 3.0，目前非常建议升级为 2.5 英寸 SATA SSD |
| 屏幕与显示     | **屏幕尺寸：** 15.6 英寸 LED 背光。<br />**分辨率：** * 主流：**1366 × 768 (HD)**<br />**视频输出：** 自带 **HDMI** 和 **VGA (D-Sub)** 接口，方便连接旧款投影仪或现代显示器。 | 高配可选：1920 × 1080 (Full HD)                       |
| 接口与外设     | **USB 接口：** 共 4 个。左侧：**USB 3.0 × 2**，右侧：**USB 2.0 × 2**<br />**网络：** 千兆以太网口 (RJ-45)，内置无线网卡 (Wi-Fi 802.11 a/b/g/n) 及 Bluetooth 4.0。<br />**光驱：** 内置 DVD 超级刻录机 (DVD Super Multi)。<br />**键盘：** 经典的富士通日语键盘（带数字小键盘区域），键程较长（约 2.5mm），手感扎实。 |                                                       |
| 物理参数       | **重量：** 约 2.3kg。<br />**尺寸：** 374 × 250 × 24.9～32.5mm。 |                                                       |
